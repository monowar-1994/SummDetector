...
class FileObject(BASE): # [ For CADETS only file type is relevant ]
    ...
    def __init__(self, uuid, base_object_host_id, base_object_permission, type, file_descriptor, local_principal, size, read_only):
        self.uuid = uuid
    ...
    def __str__(self):
        return 'FileObject(uuid={}, base_object_host_id={}, base_object_permission={}, type={}, file_descriptor={}, local_principal={}, size={}, read_only = {})'.format(self.uuid, self.base_object_host_id, self.base_object_permission, self.type, self.file_descriptor, self.local_principal, self.size, self.readonly)
